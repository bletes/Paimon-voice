...
#hps = utils.get_hparams_from_file("./configs/shanghai.json")
...
print(hps.data.filter_length // 2 + 1,hps.train.segment_size // hps.data.hop_length)
#_ = utils.load_checkpoint('shanghai.pth', net_g, None)
